...
import { Camera, Edit3, X, ShieldCheck, MapPin, User2, Building2 } from "lucide-react"
...
function AgentProfile() {
  ...
  // ====== THEME (same Travelora light theme) ======
  const glassCard =
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setProfile({
        ...
        companyName: updatedUser?.companyName ?? profile.companyName ?? "",
  ...
  const initials = useMemo(() => {
    const name = profile?.name?.trim() || user?.name?.trim() || "Agent"
        ...
        <div className={`${pageEnter ? "page-enter" : ""}`}>
          ...
          <div className="mb-8">
            ...
            <p className="mt-2 text-gray-500 max-w-2xl">
              View your agent info and update details anytime.
            </p>
          </div>
                ...
                <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="rounded-2xl bg-white/40 border border-white/50 backdrop-blur p-5">
                    ...
                    <div className="mt-4 space-y-3 text-sm">
                      ...
                      <Row label="Address" value={profile?.address} singleLine />
